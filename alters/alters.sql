...
CREATE TABLE IF NOT EXISTS order_data (
    ...
    order_data_code varchar(100) NOT NULL,
    ...
    order_data_client_main_phone varchar(20) DEFAULT NULL,
    order_data_client_second_phone varchar(20) DEFAULT NULL,
    ...
    order_data_address_number int(10) DEFAULT NULL,
