...
class ProductStockDaoUnitTest extends TestCase
{
    ...
    public function testGetParamsArrayToInsert()
    {
        ...
        $this->assertEquals(95, $paramsArray['color_id']);
        $this->assertEquals(12, $paramsArray['size_id']);
        $this->assertEquals(99, $paramsArray['brand_id']);
        $this->assertEquals(145, $paramsArray['product_id']);
