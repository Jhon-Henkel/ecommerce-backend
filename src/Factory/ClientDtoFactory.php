...
class ClientDtoFactory extends BasicDtoFactory
{
    public function factory(stdClass $item): ClientDTO
    {
        ...
        $client->setBirthDate(DateTools::stringToDateTimeConverter($item->birthDate));
    ...
    public function makePublic($item): stdClass
    {
        ...
        $client->birthDate = DateTools::dateTimeToStringConverter($item->getBirthDate());
    ...
    public function populateDbToDto(array $item): ClientDTO
    {
        ...
        $client->setBirthDate(DateTools::stringToDateTimeConverter($item['client_birth_date']));
